...
class Table1TableViewController: UITableViewController {
    ...
    @IBAction func DoTheLogOut(sender: AnyObject) {
        
        performSegueWithIdentifier("GoingToDa1stScreen", sender: self)
        
    }
    
    let mathclassesStuff = [
        ("Math 1st class"),
        ("Math 2nd class"),
        ("Math 3rd class")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        let(blabla) = mathclassesStuff[indexPath.row]
